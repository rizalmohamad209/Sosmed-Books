...
app.get("/", (req, res) => {
  let sql = [
    "SELECT buku.idbuku,nama_buku, kategori,penerbit,gambar,kategoribuku.id_kategori from buku inner join kategoribuku on buku.idkategori = kategoribuku.id_kategori",
